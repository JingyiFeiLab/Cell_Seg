...
for s_time = 1:length(time)
    for cell_num = 1:3;
        clearvars -except ref_slice_i cell_num s_time time
        filename = strcat(['/Users/reyer/Documents/MATLAB/SOURCE_CODES/Bacteria_sel_ImageProcessing_Isaac_allCell_09142015/Cell_Seg-master_Seongjin_tested/analysis21218/MR97/t',num2str(time(s_time)),'/sample_00',num2str(cell_num),'.mat']);
        
        dim  = 2;
        ref_channel = 2; % Change to most in-focus channel. Probably 2/green or 3/blue
        ref_slice = ref_slice_i(cell_num); % Change this to the most in-focus slice
        ...
        filepath = strcat(['/Users/reyer/Documents/MATLAB/SOURCE_CODES/sample_images_matt/Matt_Microscope/February_12_2018/MR97/t',num2str(time(s_time)),'/sample',num2str(cell_num)]);
        filepath_dic = strcat(['/Users/reyer/Documents/MATLAB/SOURCE_CODES/sample_images_matt/Matt_Microscope/February_12_2018/MR97/t',num2str(time(s_time)),'/dic',num2str(cell_num),'.tif']);
